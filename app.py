...
#                                                                                                                               #
#################################################################################################################################
df = pd.read_csv('/home/Guillaume/mysite/df_players_merged.csv').drop(["Unnamed: 0"], axis=1)
df_match = pd.read_csv('/home/Guillaume/mysite/df_matchs.csv').drop(["Unnamed: 0"], axis=1)
